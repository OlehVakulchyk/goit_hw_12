...
# phone1 = Phone('+380(67)777-45-32')
# phone2 = Phone('+380(67)377-45-32')
# phone3 = Phone('+380(50)777-45-32')
# phone4 = Phone('+380(63)777-45-32')
# phone5 = Phone('+380(66)777-45-32')
# phone6 = Phone('+380(68)777-45-32')


# bithday1 = Bithday('   346574657 5 6 1999')
# # print(1, bithday1.value)
# # bithday1.value = '346574657'
# #print(2, bithday1)

# record1 = Record(name1, phone1, phone2)
# record1.add_bithday(bithday1)
# record2 = Record(name2, phone3)
# record3 = Record(name3, phone4)
# record4 = Record(name4, phone5)
# record5 = Record(name5, phone6)

# # print(3, record1)
# # print(4, record1.days_to_birthday())
# # print(5, record2.bithday)

ad = AddressBook()
ad.read_from_file('ad.bin')
# ad.add_record(record1)
# ad.add_record(record2)
# ad.add_record(record3)
# ad.add_record(record4)
# ad.add_record(record5)
...
find_str = 'Ole'
print(ad.find(find_str))

# ad.write_to_file('ad.bin')
